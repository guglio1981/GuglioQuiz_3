...
import { type PlayerProfile, type Game, baseGameProfile, isAllinGame } from '@/lib/types'
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      <RulesDialog
        ...
        gameProfile={baseGameProfile(game?.game_profile)}
        allinEnabled={isAllinGame(game?.game_profile)}
        audioEnabled={!!((() => { try { return JSON.parse(game?.phase || '{}') } catch { return {} } })()).__audioEnabled}
      />
    </div>
  )
}
